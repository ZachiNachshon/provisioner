...
INTERNAL_CONFIG_TEST_DATA_FILE_PATH = "provisioner_shared/test_data/internal_config.yaml"
USER_CONFIG_TEST_DATA_FILE_PATH = "provisioner_shared/test_data/user_config.yaml"
