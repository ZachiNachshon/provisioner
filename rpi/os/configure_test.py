...
class RPiOsConfigureTestShould(unittest.TestCase):
        ...
        config = ProvisionerConfig(
            {
                "provisioner": {
                    "rpi": {
                        ...
                        "ansible": {
                            "playbook": {
                                "path": "/test/path/to/ansible/playbook",
                            }
                        },
                    }
                }
    ...
    def test_configure_os_with_custom_config_successfully(self, run_call: mock.MagicMock) -> None:
        ...
        expected_ansible_playbook_path = "/test/path/to/ansible/playbook"
    ...
    def test_configure_os_with_default_config_successfully(self, run_call: mock.MagicMock) -> None:
        ...
        self.assertEqual(fake_config.ansible_playbook_file_path, img_burner_call_args.ansible_playbook_file_path)
