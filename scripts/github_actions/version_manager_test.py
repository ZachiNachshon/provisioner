...
from version_manager import VersionManager, RC_VERSION_SUFFIX
...
"""
    ...
    def test_get_latest_rc_version_plugin(self, mock_run_command):
        ...
        mock_run_command.return_value = "provisioner-examples-plugin-v1.2.3-RC.2\nprovisioner-examples-plugin-v1.2.3-RC.1"
...
"""
    ...
    def test_cli_generate_command(self):
        ...
        with patch('version_manager.VersionManager.generate_rc_versions') as mock_generate, \
             patch('version_manager.VersionManager.check_tag_exists') as mock_check_tag, \
             patch('version_manager.VersionManager.get_current_version') as mock_get_version:
    ...
    def test_cli_plugin_mode_flag(self):
        ...
        with patch('version_manager.VersionManager.generate_rc_versions') as mock_generate, \
             patch('version_manager.VersionManager.detect_plugin_context') as mock_detect, \
             patch('version_manager.VersionManager.check_tag_exists') as mock_check_tag, \
             patch('version_manager.VersionManager.get_current_version') as mock_get_version:
            ...
            exit_code, stdout, stderr = self.run_version_manager_cli([
                "generate", str(self.temp_path), "--plugin-mode"
            ])
